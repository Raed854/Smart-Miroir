...
const Permission = (props) => {
  ...
  useEffect(() => {
    if(props.role.autorisation && props.role.autorisation[0]){
      setAutorisatione(props?.role?.autorisation);
    }
  ...
  const handleUpdate = async (id)=>{
    try {
      ...
      const url = `${API_BASE_URL}/role_autorisation/${id}/`;
                ...
                <div className='form-rights'>
                    <div className='form-right-lefts'>
                        ...
                        <div className='ckbox'>
                            ...
                            <p className="fix_p"> Show Company</p>
                        </div>
                        <div className='ckbox'>
